...
conda install nvidia/label/cuda-11.8.0::cuda-toolkit -y # fixes some weird cudnn laoding error
...
pip install opencv-python einops wandb pycocotools timm jupyter munch numpy==1.26.4
